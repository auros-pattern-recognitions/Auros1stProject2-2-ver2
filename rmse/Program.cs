...
namespace Auros1stProject2_1
{
    ...
    {
        #region  mse 리턴 함수(임시)
        static double returnMse(double thickness)
        {
        ...
        static void Main(string[] args)
        {
            ...
            double[] beforeMSEs = new double[(int)numMSE];
            double[] beforethicknesses = new double[(int)numMSE];
            ...
            while (true)
            {
                ...
                for (int i = 0; i < idx; i++)
                {
                    WriteLine($"{thicknesses[i]}       {MSEs[i]}");
                }
...
//d_sol: 1068.99036155    MSE: 2.8450619011278586E-05    idxGlobalMinimum: 1

//d_sol: 1067.9154999999998    MSE: 0.0010989511528372827    idxGlobalMinimum: 1